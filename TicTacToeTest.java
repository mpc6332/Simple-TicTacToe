...
public class TicTacToeTest
{
   ...
   */ 
   static ArrayList<Integer> userSlots = new ArrayList<Integer>();
   
   /**
   * Establishes CPU's placements in the form of An array list. Its placements
   * are recorded in an array list to check be for the game's winning conditions later on.
   */ 
   static ArrayList<Integer> cpuSlots = new ArrayList<Integer>();
   ...
   */   
   ...
   {  
      ...
      */
      ...
      userPlacement = playerMarkCheck(userPlacement);
         ...
         */
            ...
            if (resetResponse1 == "GameStop")
            {
            programEndResults(playerScore, cpuScore);
            break;
            }
            
            else if (resetResponse1 == "GameContinue")
            {
            System.out.print("Player Score: " + playerScore + "\tCPU Score: " + cpuScore + "\n");
            printGameBoard(gameBoard);
            System.out.println("Player's turn! Please enter placement between 1 - 9");
      ...
      *  the player, the program will repeatly loop until it generate a 
      ...
      */
       ...
       printGameBoard(gameBoard); 
         ...
         */            
               if (resetResponse2 == "GameStop")
               {
               programEndResults(playerScore, cpuScore);
               break;
               }
               if (resetResponse2 == "GameContinue")
               {
               System.out.print("Player Score: " + playerScore + "\tCPU Score: " + cpuScore + "\n");
               printGameBoard(gameBoard);
               }
   ...
   */
    ...
    * , which could be from anywhere between 0 to 1, by the range
    * of the acceptable input range. Then, it is added by the mininum
   ...
   *  accidently printed out. From there, it will send back the GameContinue string to
   ...
   */  
   public static String winnerCondition()
   {
      ...
      List topLeftToBottomRightCross = Arrays.asList(1, 5, 9);
      List bottomLeftToTopRightCross = Arrays.asList(3, 5, 7);
      
      List<List> winSlots = new ArrayList<List>();
      winSlots.add(topRow);
      winSlots.add(midRow);
